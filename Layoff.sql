...
ROW_NUMBER()  OVER(PARTITION BY company,industry,total_laid_off,percentage_laid_off,`date`,stage,
...
SELECT t1.industry,t2.industry FROM layoffs_staging t1 JOIN layoffs_staging t2
...
UPDATE  layoffs_staging2 t1 JOIN layoffs_staging t2
